...
$storeQuery = "SELECT storeImage FROM store WHERE storeID = '$storeID'";
$storeResult = mysqli_query($conn, $storeQuery);
$storeIMG = mysqli_fetch_assoc($storeResult);
...
<div class="productMain">
    <img src="uploads/stores/<?= htmlspecialchars($storeIMG['storeImage']) ?>">
